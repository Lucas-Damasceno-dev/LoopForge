# 📊 Project Executive Summary: divisor de despesas entre amigos: Algoritmo de equilíbrio: dado quem pagou quanto por quem, calcular o menor número de transferências (greedy por maior saldo). Testes verificam: total consistente, ninguém transfere mais que o devido, número mínimo de transações.
...
> **Stack:** `python` | **Status QA:** `FAIL` (0/1) | **Data:** 2026-08-01 06:55:30 UTC
