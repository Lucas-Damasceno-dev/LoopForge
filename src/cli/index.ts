...
program
  ...
  .argument("[directory]", "Diretório do projeto", ".")
  .option("--plan", "Executa a entrevista interativa de planejamento antes de iniciar o loop")
  .option("--skip-plan", "Pula a entrevista de planejamento e inicia o loop diretamente")
  ...
  .option("--format <format>", "Formato de saída: text|json", "text")
  .action(async (directory: string, options: { plan?: boolean; skipPlan?: boolean; createPr?: boolean; review?: boolean; auto?: boolean; watch?: boolean; format?: "json" | "text" }) => {
